...
function App() {
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        const response = await axios.get('http://127.0.0.1:5000/get-courses');
        ...
        <Col md="8" lg="5">
          ...
          {loading ? (
            ...
            <Form onSubmit={handleSubmit} className="upload-form">
              ...
              <Form.Group controlId="formBmsFile" style={{ marginTop: '20px' }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }} >
              ...
              <Form.Group controlId="formSignature" style={{ marginTop: '15px' }}>
                <Form.Label>Upload Director's Signature</Form.Label>
                <Form.Control type="file" name="signature" onChange={handleFileChange} required />
              </Form.Group>

              <Form.Group controlId="formYear" style={{ marginTop: '15px' }}>
              ...
              <Form.Group controlId="formCourseName" style={{ marginTop: '15px' }}>
                <Form.Label>Select Course Name</Form.Label>
                <Form.Control as="select" value={selectedCourse} name="selectedCourse" onChange={handleInputChange} required>
              ...
              {/* Inside the return statement, below the <Form> component */}
